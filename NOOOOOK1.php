...
ob_start();
error_reporting(0);
define('API_KEY','6751106199:AAFDOBwUK00EqNVbpJfQ8ChpHvMqyEhKfv0');
...
$Dev = array("6703043974","6703043974","6703043974"); //ID ADMIN NUMBER 1 HE CHAT
@$usernamebot = "E_0_P_bot"; //UserName Bot
@$channel = "C_8_P_H"; // UserName Channel don't @
@$token = API_KEY;
